...
public class CurrentAccount extends Account {
    ...
    public CurrentAccount(int numberAgency, int numberAccount, double balance, double overdraft,
    ...
    public void transferir(Account destiny, double value, Notification chooseNotification) {
        if (chooseNotification != null) {
            ...
            if (value > 0 && value <= (balance + overdraft)) {
                ...
                // quando tentei fazer a transferencia deu erro aqui, notification está nulo
